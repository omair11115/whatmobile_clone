...
const MOCK_PHONE: Mobile = {
  ...
  specs: {
    ...
    display: {
      ...
      extra: '120Hz, HDR10+, 2600 nits'
    },
    memory: {
      builtin: '256GB/512GB/1TB, 12GB/16GB RAM',
      card: 'No'
    },
    camera: {
      main: '200 MP + 50 MP + 10 MP + 12 MP',
      features: 'OIS, PDAF, 100x Zoom',
      front: '12 MP'
    },
    connectivity: {
      wlan: 'Wi-Fi 7',
    ...
    features: {
      sensors: 'Fingerprint, Face ID',
      audio: 'Stereo Speakers',
      browser: 'HTML5',
      messaging: 'SMS, MMS',
      games: 'Built-in',
      torch: 'Yes',
      extra: 'IP68 Water Resistant'
    },
    battery: {
      capacity: '5000 mAh',
      extra: '45W Wired, 15W Wireless'
    },
    price: {
      pkr: '350,000',
      usd: '1,199'
  ...
  description: 'The Samsung Galaxy S25 Ultra is the pinnacle of mobile engineering...',
  seoTitle: 'Samsung Galaxy S25 Ultra Full Specs, Price & Features',
  seoDescription: 'Detailed specifications of Samsung Galaxy S25 Ultra...',
  features: ['S-Pen Support', 'Galaxy AI'],
